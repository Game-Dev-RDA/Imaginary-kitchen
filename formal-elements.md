...
* המשחק מאפשר את האופציה שהאוכל ישרף אם הוא נשאר יותר מידי זמן בתהליך בישול כלשהו.
...
ישנם מספר משחקים שנראים זהים למשחק הנ"ל אך עדיין יש שינויים הניקרים באופן משמעותי בין המשחקים.
המשחק שלנו מאפשר לעשות המון פעילויות בא זמנית, וכל תהליך בביצוע ההזמנה הוא פרטני לאותו בישול. מכאן נוצר השוני בין המשחקים.
